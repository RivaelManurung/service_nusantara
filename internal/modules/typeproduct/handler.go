...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) error {
	...
	httpx.Paginated(w, r, "type products retrieved", items, page.WithTotal(total))
	return nil
}

// Get handles GET /type-product/{id}.
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) error {
	...
	httpx.OK(w, r, "type product retrieved", item)
	return nil
}

// Create handles POST /type-product/create.
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) error {
	...
	httpx.Created(w, r, "type product created", created)
	return nil
}

// Update handles PUT /type-product/{id}/edit.
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) error {
	...
	httpx.OK(w, r, "type product updated", updated)
	return nil
}

// SetStatus handles PUT /type-product/{id}/edit-status.
func (h *Handler) SetStatus(w http.ResponseWriter, r *http.Request) error {
	...
	httpx.OK(w, r, "type product status updated", nil)
	return nil
}

// Delete handles DELETE /type-product/{id}/delete.
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) error {
	...
	httpx.OK(w, r, "type product deleted", nil)
	return nil
}
